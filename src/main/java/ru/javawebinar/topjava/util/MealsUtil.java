...
//                      Collectors.toMap(Meal::getDate, Meal::getCalories, Integer::sum)
    ...
    public static List<MealWithExceed> getAllMealWithExceed(int caloriesLimit, MealDAO dao) {
        return MealsUtil.getFilteredWithExceeded(dao.getAllMeal(), LocalTime.MIN, LocalTime.MAX, caloriesLimit);
    }
}